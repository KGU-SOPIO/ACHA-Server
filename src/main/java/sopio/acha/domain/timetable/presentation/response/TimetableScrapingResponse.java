package sopio.acha.domain.timetable.presentation.response;
...
public record TimetableScrapingResponse(
	@Schema(description = "강좌 코드", example = "1493", requiredMode = REQUIRED)
	String identifier,
	...
	@Schema(description = "강의실", example = "3306", requiredMode = REQUIRED)
	String lectureRoom
) {
}
